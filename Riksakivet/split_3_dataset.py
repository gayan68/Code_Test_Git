...
for folder in folders:
    ...
    val_test_dataset = split1['test']
    split2 = val_test_dataset.train_test_split(test_size=0.5, seed=42)
    ...
    test_dir = f"/home/gayapath/PROJECTS/DATA_DGX2/Riksarkivet/test/{folder}"
