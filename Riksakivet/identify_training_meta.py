...
for item in items:
    for folder_name, splits in item.items():
        for split in splits:
            ds_path = f"/home/gayapath/PROJECTS/DATA_DGX2/Riksarkivet/{split}/{folder_name}"
...
save_path = "/home/gayapath/PROJECTS/DATA_DGX2/Riksarkivet/identify_training_meta_trval.txt"
